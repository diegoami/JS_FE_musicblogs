...
(function(window) {
	...
	this.initIframes = function(elements) {
		...
		loadingDiv.style.paddingLeft = loadingDiv.style.paddingRight = "50px";
                ...
                if (absoluteURL.test("//s3.amazonaws.com/s3.www.universalsubtitles.org/80f5480b/"))
                    loadingImg.src = "//s3.amazonaws.com/s3.www.universalsubtitles.org/80f5480b/images/embedder/loading.gif";
                else
                    loadingImg.src = parser.protocol + "//" + parser.host + "//s3.amazonaws.com/s3.www.universalsubtitles.org/80f5480b/images/embedder/loading.gif";
